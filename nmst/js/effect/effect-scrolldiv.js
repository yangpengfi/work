...
//	this.attr.height = 11000; // 内容元素的实际高度
...
//	alert('scrollHeight:'+this.attr.height+"|||view_height"+this.attr.view_height)
	ntv.log.console("ntv.effect.scroll.content.init(),"
					+ " height: " + this.attr.height
					+ " view_height: " + this.attr.view_height
					+ " part: " + this.attr.part);
//	alert("ntv.effect.scroll.content.init(),"
//					+ " height: " + this.attr.height
//					+ " view_height: " + this.attr.view_height
//					+ " part: " + this.attr.part);
};
...
//	console.log('curr_part:###'+this.attr.curr_part)
//	console.log('part:###'+this.attr.part)
